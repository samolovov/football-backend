...
insert into game_details values (3, 1, 1, 1, 'GOAL', 12);
insert into game_details values (4, 1, 1, 2, 'GOAL', 13);
insert into game_details values (5, 1, 1, 2, 'GOAL', 14);
insert into game_details values (6, 1, 1, 3, 'GOAL', 15);
insert into game_details values (7, 1, 1, 3, 'GOAL', 16);
insert into game_details values (8, 1, 2, 5, 'GOAL', 17);
insert into game_details values (9, 1, 2, 6, 'GOAL', 17);
insert into game_details values (10, 1, 2, 7, 'GOAL', 17);
insert into game_details values (11, 1, 2, 7, 'RED', 18);

insert into game_details values (12, 2, 2, 5, 'GOAL', 10);
insert into game_details values (13, 2, 3, 10, 'GOAL', 11);
insert into game_details values (14, 2, 3, 11, 'GOAL', 12);
insert into game_details values (15, 2, 3, 12, 'YELLOW', 13);

insert into game_details values (16, 3, 1, 1, 'GOAL', 10);
insert into game_details values (17, 3, 1, 1, 'GOAL', 11);
insert into game_details values (18, 3, 1, 2, 'GOAL', 12);
insert into game_details values (19, 3, 3, 10, 'AUTOGOAL', 13);
insert into game_details values (20, 3, 3, 11, 'GOAL', 14);
